...
module.exports = class extends Command {
    ...
    async run(msg) {
        ...
        const embed = new MessageEmbed()
            ...
            .addField("Description:", "For those who have a profile with Margarine, users can earn more credits by submitting suggestions, bugs, and issues via the report command. Upon completion/fix, the user is awarded an amount of credits.")
