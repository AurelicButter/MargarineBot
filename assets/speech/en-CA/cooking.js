...
exports.craft = {
    ...
    "noRow": [
        "You need to redeem your first daily before you can do this, baka!"
    ],
    "lackAmount": [
        "You do not have enough -item! Please refer to the crafting guide to find out how much you need."
    ],
    "success": [
...
exports.fish = {
    "noRow": [
        "It doesn't look like you've redeemed your first daily yet. You should do that and then come back."
    ],
    "noCredits": [
        "That's not enough credits to go fishing. Find some more and come back."
    ],
    "success": [
...
exports.sell = {
    "noRow": [
        "You need to redeem your first daily before this!"
    ],
    "noAmount": [
