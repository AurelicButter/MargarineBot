...
exports.run = (client, guild) => {
    const embed = new client.methods.Embed()
        ...
        .addField("Margarine's Message:", `Hello and thank you for inviting me to ${guild.name}! I am a somewhat helpful and lovely bot created using Komada, a Discord.js framework. To see how I will be able to assist you with, feel free to do m~help. I will send you a list of commands in which you can use. In addition, the admins and mods of your server should check the guild configurations and set it as they please. Those commands and explanations are found in the help descriptions.
